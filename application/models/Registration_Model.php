...
class Registration_Model extends CI_Model {
 	...
 	function addNewUser() {
 		$this->db->query("INSERT INTO `users` (`id`, `login`, `password`, `id_post`, `name`, `surname`, `id_avatar`, `email`, `birthday`, `id_group`, `id_invited`) VALUES (NULL, '".$_POST['login']."', '".$_POST['pass']."', '3', '".$_POST['fname']."', '".$_POST['lname']."', '6', '".$_POST['email']."', '".$_POST['birthday']."', '".$_POST['group']."', '1');"); #todo приглашен изменить + добавить группы
 	...
 	function checkData() {
 		...
 		header('Location: /user/'.$this->addNewUser());
